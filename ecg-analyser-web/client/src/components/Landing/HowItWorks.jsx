    ...
    <section id="how-it-works" className="py-24 relative bg-[var(--bg-secondary)] overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 relative">
          {steps.map((step, i) => (
            <div key={i} className="relative animate-slide-up" style={{ animationDelay: `${i * 200}ms` }}>
              <div className="glass-card rounded-2xl p-8 h-full">
                <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${step.color} flex items-center justify-center mb-6 text-2xl font-bold text-white`}>
                  {step.num}
                </div>
